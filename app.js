...
checkButton.addEventListener("click", function checkPalindromeBirthdayHandler() {
    ...
    if(dateStr !== '') {
        ...
        if(isPalindrome) {
            ...
            if(ctr < 0) {
                showMessage("Nooo!!! 🙄 Your birthday is not a palindrome. The nearest palindrome date is " + palindromeDate.day + "-" + palindromeDate.month + "-" + palindromeDate.year + " which is " + Math.abs(ctr) + " days before your birthday.");
            } else {
                showMessage("Nooo!!! 🙄 Your birthday is not a palindrome. The nearest palindrome date is " + palindromeDate.day + "-" + palindromeDate.month + "-" + palindromeDate.year + " which is " + ctr + " days after your birthday.");
            }
